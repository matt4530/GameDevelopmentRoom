		...
		public override void GotMessage(Player player, Message message) {
			switch(message.Type) {
				case "ChatMessage": {
                    ...
                    else if (m.IndexOf("/setColor") == 0 && player.ConnectUserId == "kong1138933")
                    {
                        try
                        {
                            ...
                            for (int r = 1; r < people.Length - 1; r++)
                            {
                                foreach (Player p in Players)
                                {
                                    ...
                                    {
                                        p.Color = people[people.Length - 1];
                                    }
                                }
                            }
                        }
